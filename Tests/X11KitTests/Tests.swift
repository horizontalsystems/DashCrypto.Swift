...
class Tests: XCTestCase {
    ...
    func testJHValue() {
        ...
        XCTAssertEqual(X11Kit.jh512(data), hash)
    }
    ...
    func testBmw512Value() {
        ...
        XCTAssertEqual(X11Kit.bmw512(data), hash)
    }
    ...
    func testEcho512Value() {
        ...
        XCTAssertEqual(X11Kit.echo512(data), hash)
    }
    ...
    func testSimdEmpty() {
        ...
        XCTAssertEqual(X11Kit.simd512(data), hash)
    }
    ...
    func testBlakeEmpty() {
        ...
        XCTAssertEqual(X11Kit.blake512(data), hash)
    }
    ...
    func testLuffaValue() {
        ...
        XCTAssertEqual(X11Kit.luffa512(data), hash)
    }
    ...
    func testSkein512Value() {
        ...
        XCTAssertEqual(X11Kit.skein512(data), hash)
    }
    ...
    func testKessak512Empty() {
        ...
        XCTAssertEqual(X11Kit.keccak512(data), hash)
    }
    ...
    func testGroestl512Empty() {
        ...
        XCTAssertEqual(X11Kit.groestl512(data), hash)
    }
    ...
    func testShavite512Value() {
        ...
        XCTAssertEqual(X11Kit.shavite512(data), hash)
    }
    ...
    func testCubeHash512Value() {
        ...
        XCTAssertEqual(X11Kit.cubehash512(data), hash)
    }
